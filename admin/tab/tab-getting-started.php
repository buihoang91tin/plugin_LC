	...
	<div class="extensions wp-clearfix">
		...
		<div class="extension" tabindex="0" >
			<div class="extension-screenshot">
				<img alt="" src="<?php echo AS_EXTENSION_URL; ?>/images/lc-extension-videoembed.png">
			</div>
		...
		<div class="extension" tabindex="0" >
			<div class="extension-screenshot">
				<img alt="" src="<?php echo AS_EXTENSION_URL; ?>/images/lc-extension-animations.png">
			</div>
...
<div class="extension-browser rendered">
	<div class="extensions wp-clearfix">
		...
		<div class="extension" tabindex="0" >
			<div class="extension-screenshot">
				<img alt="" src="<?php echo AS_EXTENSION_URL; ?>/images/lc-theme-blank.png">
			</div>
		...
		<div class="extension" tabindex="0" >
			<div class="extension-screenshot">
				<img alt="" src="<?php echo AS_EXTENSION_URL; ?>/images/lc-theme-orao.png">
			</div>
