...
function as_feature_control_settings() {
...
} add_action( 'dslc_hook_register_modules', 'as_feature_control_settings', 999 );

function as_feature_control_unregister() {
...
} add_action( 'dslc_hook_unregister_modules', 'as_feature_control_unregister', 999 );
...
} add_action( 'dslc_hook_register_options', 'as_plugin_opts_other', 50 );

	var_dump($dslc_plugin_options);
?>

<form>ádfasdfsdf</form>