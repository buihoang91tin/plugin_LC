	...
	<div class="dslc-panel-content">
		...
		<div class="dslc-panel-column-container">
			<div class="dslc-panel-column">
				<h3><span class="dashicons dashicons-dashboard"></span> <?php _e( 'Extremely Fast', 'asex_extension' ); ?></h3>
				<p><?php _e( 'New Live Composer is completely rewritten using JavaScript. It\'s fast and reliable on any server delivering a great user experience and faster site loading times.', 'asex_extension' ); ?></p>
			</div>
			<div class="dslc-panel-column">
				<h3><span class="dashicons dashicons-update"></span> <?php _e( "Better Integrated", 'asex_extension' ); ?></h3>
				<p><?php _e( 'We redesigned user interface from scratch. The new version is better integrated with WordPress UI making it more effective for both advacned and new users.', 'asex_extension' ); ?></p>
			</div>
			<div class="dslc-panel-column dslc-panel-last">
				<h3><span class="dashicons dashicons-unlock"></span> <?php _e( "100% Open Source", 'asex_extension' ); ?></h3>
				<p><?php _e( 'Unlike other popular page builders, Live Composer remains to be 100% open source plugin. Build premium theme business with our page builder. ', 'asex_extension' ); ?></p>
			</div>
		</div>
	</div>
</div>
