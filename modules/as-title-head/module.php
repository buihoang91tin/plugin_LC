...
class ASEX_Heading_Title_Module extends ASEX_MODULE {

    // Module Attributes
    var $module_id       = 'ASEX_Heading_Title_Module';
    ...
    function options() {
        ...
        $dslc_options = array(
            ...
            array(
                ...
                'id'      => 'elements',
                'std'     => 'asex_title asex_sub_title asex_line_heading',
                'type'    => 'checkbox',
                'choices' => array(
                    array(
            ...
            array(
                'label'                 => __('Padding Horizontal', 'live-composer-page-builder'),
                'id'                    => 'asex_css_title_padding_horizontal',
                'std'                   => '10',
                'type'                  => 'slider',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-heading-title .as-big-title-heading',
            ...
            array(
                'label'                 => __('Padding Vertical', 'live-composer-page-builder'),
                'id'                    => 'asex_css_title_padding_vertical',
                'std'                   => '10',
                'type'                  => 'slider',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-heading-title .as-big-title-heading',
            ...
            array(
                ...
                'id'                    => 'asex_css_title_margin_horizontal',
                'std'                   => '',
                'type'                  => 'slider',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-heading-title .as-big-title-heading',
            ...
            array(
                'label'                 => __('BG Color', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_bg_color',
                'std'                   => '',
                'type'                  => 'color',
                'refresh_on_change'     => false,
            ...
            array(
                'label'                 => __('BG Image', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_bg_img',
                'std'                   => '',
                'type'                  => 'image',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-line-heading-wrapper',
            ...
            array(
                'label'                 => __('BG Image Repeat', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_bg_img_repeat',
                'std'                   => 'repeat',
                'type'                  => 'select',
                'choices'               => array(
                    array(
            ...
            array(
                'label'                 => __('BG Image Attachment', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_bg_img_attch',
                'std'                   => 'scroll',
                'type'                  => 'select',
                'choices'               => array(
                    array(
            ...
            array(
                'label'                 => __('BG Image Position', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_bg_img_pos',
                'std'                   => 'top left',
                'type'                  => 'select',
                'choices'               => array(
                    array(
            ...
            array(
                'label'                 => __('Border Color', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_border_color',
                'std'                   => 'rgb(0, 186, 208)',
                'type'                  => 'color',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-line-heading-wrapper',
            ...
            array(
                'label'                 => __('Border Width', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_border_width',
                'std'                   => '1',
                'type'                  => 'slider',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-line-heading-wrapper',
            ...
            array(
                'label'                 => __('Borders', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_border_trbl',
                'std'                   => 'top right bottom left',
                'type'                  => 'checkbox',
                'choices'               => array(
                    array(
            ...
            array(
                ...
                'id'                    => 'asex_line_heading_css_main_border_radius_top',
                'std'                   => '0',
                'type'                  => 'slider',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-line-heading-wrapper',
            ...
            array(
                ...
                'id'                    => 'asex_line_heading_css_main_border_radius_bottom',
                'std'                   => '0',
                'type'                  => 'slider',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-line-heading-wrapper',
            ...
            array(
                'label'                 => __('Width', 'live-composer-page-builder'),
                'id'                    => 'asex_line_heading_css_main_border_width_real',
                'std'                   => '20',
                'type'                  => 'slider',
                'refresh_on_change'     => false,
                'affect_on_change_el'   => '.as-line-heading-wrapper',
