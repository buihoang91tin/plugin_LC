...
class ASEX_Posts extends ASEX_MODULE {
    ...
    function __construct() {
        ...
        $this->module_id       = 'ASEX_Posts';
        $this->module_title    = __('AS - Custom Posts', 'asex');
    ...
    function options() {
        ...
        $dslc_options = array(
            ...
            array(
                'label'             => __('Duration when hover link(ms)', 'asex'),
                'id'                => 'asex_duration_hover',
                'std'               => '300',
                'type'              => 'text',
            ...
            array(
                ...
                'choices' => array(
                    array(
                        'label' => __('Bellow Thumbnail', 'asex'),
                        'value' => 'bellow'
                    ),
                    array(
                        'label' => __('Inside Thumbnail ( hover )', 'asex'),
                        'value' => 'inside'
                    ),
                    array(
                        'label' => __('Inside Thumbnail ( always visible )', 'asex'),
            ...
            array(
                'label'                 => __('Link - Color Author', 'asex'),
            ...
            array(
                'label'                 => __('Link - Hover - Color Author', 'asex'),
            ...
            array(
                'label'                 => __('Link - Color Categories', 'asex'),
            ...
            array(
                'label'                 => __('Link - Hover - Color Categories', 'asex'),
            ...
            /* 			array(
              'label' => __( 'Icon - Margin Right', 'asex_extension' ),
            ...
            array(
                'label'                 => __('Padding Vertical Wrapper', 'asex'),
            ...
            array(
                'label'                 => __('Padding Horizontal Wrapper', 'asex'),
            ...
            array(
                'label'                 => __('Thumbnail - Margin Right', 'asex'),
            ...
            array(
                'label'                 => __('Meta - Margin Bottom', 'asex'),
            ...
            array(
                'label'                 => __('Meta - Padding Vertical', 'asex'),
            ...
            array(
                'label'                 => __('Meta - Padding Horizontal', 'asex'),
    ...
    function output($options) {
         ...
         */
        $duration_hover = '';
        $value_duration = $options['asex_duration_hover'];
        if ($value_duration != '') {
            $duration_hover = '
					<style>
            ...
            <?php endif; ?>
                ...
                if ($show_filters) {
                    ...
                    <div class="dslc-post-filters">
                        ...
                        <span class="dslc-post-filter dslc-active" data-id=" "><?php _ex('All', 'Post Filter', 'asex'); ?></span>
        ...
        if ($dslc_query->have_posts()) {
            ...
            <div class="as-custom-post-class <?php echo esc_attr($container_class); ?>"><?php
                    ...
                    <?php if (has_post_thumbnail()) : ?>
                        ...
                        <?php if (( $options['main_location'] == 'inside' || $options['main_location'] == 'inside_visible' ) && ( $post_elements == 'all' || in_array('title', $post_elements) || in_array('meta', $post_elements) || in_array('excerpt', $post_elements) || in_array('button', $post_elements) )) : ?>
                            ...
                            <?php if ($post_elements == 'all' || in_array('meta', $post_elements)) : ?>
                                ...
                                <?php _e('By', 'asex'); ?> <?php the_author_posts_link(); ?>
                        ...
                        <?php endif; ?>
                                                ...
                                                <div class="as-post-like-share">
                                                    <div class="as-btn-heart-blog">
                                                        <a href="#" class="as-post-like <?php echo asex_is_like_post($post->ID); ?>" data-id="<?php echo get_the_ID(); ?>">
                                                            <span class="dslc-icon dslc-icon-heart-empty"></span>
                                                            <span class="number-like-heart">
                                                                <?php
                                                                echo get_post_meta($post->ID, 'asex_like_count', true) ? get_post_meta($post->ID, 'asex_like_count', true) : 0;
                                                                ?>
                                                            </span>
                                                        </a>
                                                    </div>
                ...
                if ($dslc_is_admin) :
                    ?><div class="dslc-notification dslc-red"><?php _e('You do not have any posts of that post type at the moment.', 'asex'); ?> <span class="dslca-refresh-module-hook dslc-icon dslc-icon-refresh"></span></span></div><?php
            endif;
        }
