...
class AS_Posts extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_title = __( 'AS - Custom Posts', 'dslc_string' );
	...
	function options() {
		...
		$dslc_options = array(
			...
			array(
				'label' => __( 'Link - Color Author', 'dslc_string' ),
			...
			array(
				'label' => __( 'Link - Hover - Color Author', 'dslc_string' ),
			...
			array(
				'label' => __( 'Link - Color Categories', 'dslc_string' ),
			...
			array(
				'label' => __( 'Link - Hover - Color Categories', 'dslc_string' ),
