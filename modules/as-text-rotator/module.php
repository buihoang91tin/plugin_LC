...
class AS_text_rotator extends DSLC_Module {
	...
	<div class="as-text-body">
		 <div class="as-text-wraper">
			  ...
			  <div class="as-text-main" data-speed-text = "<?php echo $as_speed_text;?>">
			    <h1 class="as-text-row-1"><?php echo esc_attr($options['as_rotator_1']);?> <span class="rotate" data-anim-text="<?php echo $options['as_rotator_style'];?>"><?php echo esc_attr($options['as_rotator_2']);?></span> <?php echo esc_attr($options['as_rotator_3']);?></h1>
		   	 </div>
 		 </div>
 	</div>	
