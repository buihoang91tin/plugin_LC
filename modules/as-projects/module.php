							...
							if ( $show_filters ) {
								...
								?>
									...
									<div class="dslc-post-filters">
										...
										<span class="dslc-post-filter as-isotope-filter dslc-active" data-id=" "><?php _e( 'All', 'Post Filter', 'dslc_string' ); ?></span>

										<?php foreach ( $cats_array as $cat_slug => $cat_name ) : ?>
											<span class="dslc-post-filter as-isotope-filter dslc-inactive" data-id="<?php echo $cat_slug; ?>"><?php echo $cat_name; ?></span>
										<?php endforeach; ?>
								...
								<?php if ( has_post_thumbnail() ) : ?>
									...
									<div class="dslc-post-thumb dslc-project-thumb dslc-on-hover-anim as-project-custom">
										...
										<?php if ( ( $post_elements == 'all' || in_array( 'title', $post_elements ) || in_array( 'categories', $post_elements ) || in_array( 'excerpt', $post_elements ) || in_array( 'button', $post_elements ) ) ) : ?>
											...
											<div class="dslc-project-main dslc-on-hover-anim-target" <?php echo $duration_hover; ?>>
												...
												<div class="dslc-project-main-inner">
													...
													<?php if ( $post_elements == 'all' || in_array( 'icon_link', $post_elements ) ) : ?>
														<div class="as-group-icon-project">
															...
															<a class="as-link-to-project" data-ajax="<?php echo isset($options['as_ajax_projects']) && $options['as_ajax_projects'] ? '1' : '0'; ?>" data-id="<?php echo get_the_ID(); ?>" href="<?php echo $the_project_url; ?>" target="<?php echo $the_project_url_target; ?>"><span class="dslc-icon dslc-icon-link"></span></a>
														</div>
													<?php endif; ?>
