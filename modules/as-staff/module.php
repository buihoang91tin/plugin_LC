	...
	function options() {
		...
		$dslc_options = array(
			...
			array(
				...
				'choices' => array(
					array(
						'label' => __( 'Inner Thumbnail', 'dslc_string' ),
						'value' => 'top'
					),
					array(
						'label' => __( 'Bottom Thumbnail', 'dslc_string' ),
						'value' => 'bottom'
					),
				),
				'section' => 'styling',
			...
			array(
				'label' => __( 'Icon - Spacing', 'dslc_string' ),
			 ...
			 */
			array(
				'label' => __( 'Content Inner Thumbnail', 'dslc_string' ),
