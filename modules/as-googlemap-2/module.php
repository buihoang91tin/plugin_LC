...
class AS_Google_Map_2 extends DSLC_Module
{
	// Module Attributes
	var $module_id;
	var $module_title;
	...
	function __construct() {
		...
		$this->module_id = 'AS_Google_Map_2';
		$this->module_title = __( 'Google Map 2', 'dslc_string' );
