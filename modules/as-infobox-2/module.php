...
class AS_Info_Box_2 extends DSLC_Module {
                    ...
                    <div class="dslc-info-box-icon-bellow-title">
                        <div class="dslc-info-box-icon-bellow-title-inner as-float-left">
                            ...
                            <?php if (!empty($options['icon_link'])) : ?>
                                <a class="dslc-info-box-image-link" href="<?php echo esc_url($options['icon_link']); ?>" target="<?php echo esc_attr($options['icon_link_target']); ?>"></a>
                            <?php endif; ?>
