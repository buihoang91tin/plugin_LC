...
class AS_Info_Box_4 extends DSLC_Module {
    ...
    function __construct() {
        ...
        $this->module_title    = __('Info Box 4', 'dslc_string');
        ...
        $dslc_options = array(
            ...
            array(
                ...
                'choices' => array(
                    ...
                    array(
                        'label' => __('Style 7a', 'dslc_string'),
                        'value' => 'hi-icon-effect-7 hi-icon-effect-7a',
                    ),
                    array(
                        'label' => __('Style 7b', 'dslc_string'),
                    ...
                    array(
                        'label' => __('Style 9a', 'dslc_string'),
                        'value' => 'hi-icon-effect-9 hi-icon-effect-9a',
                    ),
                    array(
                        'label' => __('Style 9b', 'dslc_string'),
            ...
            array(
                'label'                 => __('Color Box Shadown ( Icon )', 'dslc_string'),
                ...
                'section'               => 'styling',
                'tab'                   => __('Icon', 'dslc_string'),
                'help'                  => __('Color will change when you save option module!', 'dslc_string'),
            ),
            array(
                    ...
                    <div class="dslc-info-box-image">
                        <div class="hi-icon-wrap <?php echo esc_attr($options['as_effect_id']); ?>">
                            <?php if (!empty($options['icon_link'])) { ?> 
                                <a class="dslc-info-box-image-link" href="<?php echo esc_url($options['icon_link']); ?>" target="<?php echo esc_attr($options['icon_link_target']); ?>">
                                <?php } ?>
                                <span class="hi-icon">
